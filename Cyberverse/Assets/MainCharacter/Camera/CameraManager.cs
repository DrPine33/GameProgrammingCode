...
public class CameraManager : MonoBehaviour
{
    ...
    public Transform targetTransform;   //This is the object that the camera will follow
    ...
    {
        Vector3 targetPosition = Vector3.SmoothDamp(transform.position, targetTransform.position, ref cameraFollowVeclocity, cameraFollowSpeed);
